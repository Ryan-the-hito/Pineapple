class window_about(QWidget):  # 增加说明页面(About)
    ...
    def setUpMainWindow(self):
        widg1 = QWidget()
        l1 = QLabel(self)
        png = PyQt6.QtGui.QPixmap('pineapple.png')  # 调用QtGui.QPixmap方法，打开一个图片，存放在变量png中
        ...
        widg5 = QWidget()
        lbl3 = QLabel('And always free.', self)
        blay5 = QHBoxLayout()
